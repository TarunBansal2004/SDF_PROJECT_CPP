...
void firstPage()
{
    ...
    cout << "__________________________ [ WELCOME TO RAILLINK RAILWAYS ]___________________________" << endl;
    ...
    cout << "\t\t\t   |\t 3. Exit          \t|" << endl;
    int choice;
    string id = "bansaltarun2004@gmail.com";
    string password = "Tarun9997#";
    string eid, pass;
    ...
    {
        system("cls");
        cout << "___________________Thanks for using RAILLINK Railways_____________________" << endl
             << endl;
        exit(0);
    }
    }
...
public:
    ...
    void dispBill()
    {
        ...
        cout << "____RAILLINK RAILWAYS_____" << endl;
